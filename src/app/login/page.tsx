        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="password" value={password} onChange={(e) => setPassword(e.target.value)}
                  className="w-full bg-white/5 border border-white/10 rounded-lg pl-10 pr-4 py-3 text-white placeholder-white/30 focus:outline-none focus:border-purple-500" placeholder="••••••••" required />
              </div>
            </div>
          ...
          <div className="mt-6">
            ...
            <button onClick={handleGoogleLogin}
              className="mt-4 w-full bg-white hover:bg-gray-100 text-gray-900 py-3 rounded-lg font-medium flex items-center justify-center gap-2">
